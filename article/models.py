...
class ArticleInfo(models.Model):
    ...
    articlephoto = models.ImageField('文章图片', blank=True,
    ...
    article_tag = models.ManyToManyField(ArticleTag, blank=True,
                                         verbose_name='文章标签')
...
class Comment(models.Model):
    ...
    created = models.DateTimeField('创建时间', auto_now_add=True)   # auto_now_add 在之后的save()是可以手动赋值的
